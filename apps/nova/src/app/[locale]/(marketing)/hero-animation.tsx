  ...
  return (
    <div className="pointer-events-none fixed inset-0">
      ...
      >
        ...
        <motion.div
          className="pointer-events-none absolute h-100 w-100 -translate-x-1/3 -translate-y-1/3 rounded-full bg-linear-to-r from-violet-400/20 via-purple-400/20 to-fuchsia-400/20 blur-xl will-change-transform md:h-150 md:w-150 md:blur-2xl dark:from-fuchsia-400/30 dark:via-rose-400/30 dark:to-purple-400/30"
          animate={{
        ...
        <motion.div
          className="pointer-events-none absolute h-75 w-75 translate-x-1/4 translate-y-1/4 rounded-full bg-linear-to-r from-emerald-400/20 via-teal-400/20 to-cyan-400/20 blur-xl will-change-transform md:h-125 md:w-125 md:blur-2xl dark:from-cyan-400/20 dark:via-teal-400/20 dark:to-emerald-400/20"
          animate={{
        ...
        <motion.div
          className="pointer-events-none absolute h-[250px] w-[250px] -translate-x-1/4 -translate-y-1/4 rounded-full bg-linear-to-r from-blue-400/20 via-indigo-400/20 to-violet-400/20 blur-xl will-change-transform md:h-100 md:w-100 md:blur-2xl dark:from-violet-400/30 dark:via-indigo-400/30 dark:to-blue-400/30"
          animate={{
            x: [0, 200, -200, 0],
            y: [0, -200, 200, 0],
