...
import { useMiraCalendar } from '../../hooks/use-calendar';
import type { MiraCalendarEvent } from '../../types/mira';
...
export function CalendarPanel({ wsId, className }: CalendarPanelProps) {
  const { data: calendarData, isLoading } = useMiraCalendar({ wsId });
  ...
  const eventsByDate = events.reduce(
    ...
    {} as Record<string, MiraCalendarEvent[]>
  );
