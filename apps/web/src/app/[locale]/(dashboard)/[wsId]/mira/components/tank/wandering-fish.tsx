...
import type { MiraAnimationState, MiraMood } from '../../types/mira';

interface WanderingFishProps {
  mood: MiraMood;
  animationState: MiraAnimationState;
  isFocusMode?: boolean;
  className?: string;
}

// Fish color based on mood
const moodColors: Record<MiraMood, string> = {
...
const ACTIVE_STATES: MiraAnimationState[] = [
  'speaking',
  'listening',
  'eating',
  'celebrating',
