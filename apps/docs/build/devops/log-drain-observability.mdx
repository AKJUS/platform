...
Infrastructure → Monitoring → Resources reads the blue/green Docker snapshot and displays container health, image/service identity, CPU, memory, network ingress/egress, and aggregate service counts. This is the operator view for Docker Desktop resource pressure without opening Docker Desktop directly.
