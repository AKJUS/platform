...
```bash
bun serve:web:docker:bg -- --build-memory 10g --build-cpus 2 --build-max-parallelism 1
```

Current root-script defaults:

- `bun serve:web:docker` defaults to `--build-memory 10g --build-cpus 2 --build-max-parallelism 1`
- `bun serve:web:docker:bg` defaults to `--build-memory 10g --build-cpus 2 --build-max-parallelism 1`
