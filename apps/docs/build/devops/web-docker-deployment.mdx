...
- `bun serve:web:docker` defaults to `--build-memory 8g --build-cpus 4 --build-max-parallelism 2`
- `bun serve:web:docker:bg` defaults to `--build-memory 8g --build-cpus 4 --build-max-parallelism 2`
